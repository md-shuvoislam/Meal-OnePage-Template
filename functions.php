...
if ( site_url() == "http://localhost/themedev" ) {
    define( "VERSION", time() );
} else {
...
function meal_assets() {
    ...
    wp_enqueue_script('google-map-js','//maps.googleapis.com/maps/api/js?key=AIzaSyA5rdVrl4iX27DbcQiHuD9zb9hZXen4Bzo',null,'1.0',true);
